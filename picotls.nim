...
type
  ...
  struct_st_ptls_hpke_cipher_suite_t_536871444 {.pure, inheritable, bycopy.} = object
    ...
    hash*: ptr ptls_hash_algorithm_t_536871427
    aead*: ptr ptls_aead_algorithm_t_536871415
  ptls_hpke_cipher_suite_t_536871446 = struct_st_ptls_hpke_cipher_suite_t_536871445 ## Generated based on /home/r/vacp2p/nim-ngtcp2/libs/picotls/include/picotls.h:678:3
  ...
  ssize_t_536871501 = compiler_ssize_t_536871548 ## Generated based on /usr/include/x86_64-linux-gnu/sys/types.h:108:19
  ...
  struct_in_addr_536871545 {.pure, inheritable, bycopy.} = object
    s_addr*: in_addr_t_536871550 ## Generated based on /usr/include/netinet/in.h:31:8
  compiler_ssize_t_536871547 = clong ## Generated based on /usr/include/x86_64-linux-gnu/bits/types.h:194:27
  in_addr_t_536871549 = uint32 ## Generated based on /usr/include/netinet/in.h:30:18
  ...
  compiler_ssize_t_536871548 = (when declared(compiler_ssize_t):
    when ownSizeof(compiler_ssize_t) != ownSizeof(compiler_ssize_t_536871547):
      static :
        warning("Declaration of " & "compiler_ssize_t" &
            " exists but with different size")
    compiler_ssize_t
   else:
    compiler_ssize_t_536871547)
  ...
  in_addr_t_536871550 = (when declared(in_addr_t):
    when ownSizeof(in_addr_t) != ownSizeof(in_addr_t_536871549):
      static :
...
when not declared(compiler_ssize_t):
  type
    compiler_ssize_t* = compiler_ssize_t_536871547
else:
  static :
